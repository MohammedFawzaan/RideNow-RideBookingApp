...
// module.exports.getCaptainsInTheRadius = async (ltd, lng, radius) => {
//     const findCaptains = await captainModel.find({
//         'location.ltd': { $ne: null },
//         'location.lng': { $ne: null },
//         status: 'active'
//     });

//     const captains = findCaptains.filter((captain) => {
//         const { ltd: capLat, lng: capLng } = captain.location;
//         const distance = haversineDistance(ltd, lng, capLat, capLng);
