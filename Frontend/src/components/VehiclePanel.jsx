...
const VehiclePanel = (props) => {
    return (
        <div>
            ...
            <div onClick={() => { props.setVehiclePanel(false); props.setConfirmRidePanel(true); props.selectVehicle('car'); props.setVehicleImage(CarImage); }} className='w-full mb-2 flex items-center justify-between cursor-pointer border-2 active:border-black rounded-xl p-3'>
            ...
            <div onClick={() => { props.setVehiclePanel(false); props.setConfirmRidePanel(true); props.selectVehicle('moto'); props.setVehicleImage(MotoImage); }} className='w-full mb-2 flex items-center justify-between cursor-pointer border-2 active:border-black rounded-xl p-3'>
            ...
            <div onClick={() => { props.setVehiclePanel(false); props.setConfirmRidePanel(true); props.selectVehicle('auto'); props.setVehicleImage(AutoImage); }} className='w-full mb-2 flex items-center justify-between cursor-pointer border-2 active:border-black rounded-xl p-3'>
